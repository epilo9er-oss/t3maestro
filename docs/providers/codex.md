...
This guide is for people who want to use more than one Codex account in T3 Maestro.
...
In T3 Maestro Settings, name it something obvious:
...
In T3 Maestro Settings, add another Codex provider:
...
T3 Maestro shows the authenticated email for providers that report one. Emails are blurred by default;
...
If you add a third Codex provider with a completely different `CODEX_HOME path`, T3 Maestro treats it
