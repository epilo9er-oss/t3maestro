...
This guide is for people who want to use more than one Codex account in T3 Synapse.
...
In T3 Synapse Settings, name it something obvious:
...
In T3 Synapse Settings, add another Codex provider:
...
T3 Synapse shows the authenticated email for providers that report one. Emails are blurred by default;
...
If you add a third Codex provider with a completely different `CODEX_HOME path`, T3 Synapse treats it
