// This file mostly exists because we want dev mode to say "T3 Synapse (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "T3 Synapse (Dev)" : "T3 Synapse (Alpha)";
