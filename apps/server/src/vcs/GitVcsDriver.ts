...
export interface GitVcsDriverShape {
  ...
  readonly readWorkingTreeDiff: (cwd: string) => Effect.Effect<VcsDiffResult, GitCommandError>;
  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const commitEnv: NodeJS.ProcessEnv = {
        ...
        GIT_AUTHOR_NAME: "T3 Maestro",
        GIT_AUTHOR_EMAIL: "t3maestro@users.noreply.github.com",
        GIT_COMMITTER_NAME: "T3 Maestro",
        GIT_COMMITTER_EMAIL: "t3maestro@users.noreply.github.com",
      };
