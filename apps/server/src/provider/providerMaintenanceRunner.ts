            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but T3 Synapse could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but T3 Synapse still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
