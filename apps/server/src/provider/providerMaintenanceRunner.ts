            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but T3 Maestro could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but T3 Maestro still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
