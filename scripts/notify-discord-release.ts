  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new T3 Maestro prerelease is available for nightly testers."
          : "A new T3 Maestro latest release is available.",
...
).pipe(Command.withDescription("Post a T3 Maestro release announcement to Discord."));
