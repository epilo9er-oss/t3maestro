  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new T3 Synapse prerelease is available for nightly testers."
          : "A new T3 Synapse latest release is available.",
...
).pipe(Command.withDescription("Post a T3 Synapse release announcement to Discord."));
